...
THEME_EDITOR_DEFAULTS: Dict[str, Any] = {
    ...
    "font_categories": ["default", "heading", "body", "caption", "button"],
...
PREVIEW_DEFAULTS: Dict[str, Any] = {
    ...
    "widget_states": ["normal", "hover", "pressed", "disabled", "focused"],
}

# エクスポート形式のデフォルト設定
EXPORT_FORMAT_DEFAULTS: Dict[str, Any] = {
    "json": {"indent": 2, "ensure_ascii": False, "include_comments": True},
    "qss": {"minify": False, "include_comments": True, "sort_selectors": True},
    "css": {"minify": False, "include_comments": True, "sort_properties": True},
}
...
VALIDATION_DEFAULTS: Dict[str, Any] = {
    "required_properties": ["name", "version", "colors"],
