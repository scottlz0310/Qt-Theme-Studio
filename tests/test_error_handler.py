...
class TestErrorHandler:
    ...
    def test_find_backup_files(self):
        ...
        backup_file1 = self.error_handler.backup_directory / f"{original_file}.20231201_120000.backup"
        backup_file2 = self.error_handler.backup_directory / f"{original_file}.20231201_130000.backup"
