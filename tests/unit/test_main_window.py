...
class TestQtThemeStudioMainWindow:
    ...
    def test_set_color_button(self):
        ...
        # メソッドが呼ばれたことを確認
        self.main_window.set_color_button.assert_called_once_with("background", test_color)
    ...
    def test_theme_selection_workflow(self):
        ...
        # テーマデータを取得
        assert self.main_window.themes[self.main_window.current_theme_name] == test_theme
